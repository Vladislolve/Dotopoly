...
function _ScoreboardUpdater_UpdatePlayerPanel( scoreboardConfig, playersContainer, playerId, localPlayerTeamId )
{
	...
	if ( playerInfo )
	{
		...
		_ScoreboardUpdater_SetTextSafe( playerPanel, "Kills", playerInfo.player_gold ); // _ScoreboardUpdater_SetTextSafe( playerPanel, "Kills", playerInfo.player_kills );
		...
		if ( playerPortrait )
		{
			...
			{
				playerPortrait.SetImage( "file://{images}/heroes/" + playerInfo.player_selected_hero + ".png");//"file://{images}/heroes/" + playerInfo.player_selected_hero + ".png" 
			}
			else
			{
...
//		$.Msg( "UpdateTeamPanel.Create: ", teamPanelName, " = ", scoreboardConfig.teamXmlName );
	...
	_ScoreboardUpdater_SetTextSafe( teamPanel, "TeamScore", teamDetails.team_score ) // _ScoreboardUpdater_SetTextSafe( teamPanel, "TeamScore", teamDetails.team_score )
